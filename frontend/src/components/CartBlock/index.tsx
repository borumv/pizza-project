...
const CartBlock: React.FC = () => {
  ...
  return (
    <>
      {/* <div className={`cart__popup ${showPopup ? 'cart__popup--visible' : ''}`}>
        <PopUp />
      </div> */}
      {/* <div className={`overlay ${showPopup ? 'overlay--visible' : ''}`} /> */}
      {showPopup && (
        <div className={`modal ${showPopup ? 'fade-in' : ''}`} id="exampleModal" aria-hidden="true">
        ...
        <div className="cart">
          ...
          <div className="cart__bottom">
            ...
            <div className="cart__bottom-buttons">
              ...
              <div className="button pay-btn" onClick={() => setShowPopup(!showPopup)}>
